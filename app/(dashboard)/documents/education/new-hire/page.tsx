...
export default function EduPage() {
  ...
  useEffect(() => {
    fetch('/api/documents/education?edu_type=new-hire&exclude_worker_type=atypical')
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-0.5">산안법 제29조 제1항 | 채용 후 즉시 실시</p>
          </div>
        </div>
        <Link href="/documents/education/new?edu_type=new-hire"
          className="btn-primary text-sm gap-1.5" style={{background:'#16a34a'}}>
          <Plus className="w-4 h-4" /> 교육일지 작성
        </Link>
      </div>

      <div className="card p-4 mb-4" style={{background:'#f0fdf4',borderColor:'#16a34a20'}}>
        <p className="text-xs leading-relaxed" style={{color:'#16a34a'}}>신규 채용 즉시 실시 의무 | 근무형태별 법정 교육시간이 다릅니다 (아래 참고)</p>
      </div>


      <div className="grid grid-cols-4 gap-2 mb-4">
        {[['일용직', '1시간', '#fef2f2', '#dc2626'],
          ['단기간', '2시간', '#fffbeb', '#d97706'],
          ['상용 사무직', '8시간', '#eff6ff', '#2563eb'],
          ['상용 현장직', '8시간', '#eff6ff', '#2563eb'],
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="py-14 text-center text-sm text-gray-400">
            ...
            <p>아직 교육일지가 없습니다.</p>
            <Link href="/documents/education/new?edu_type=new-hire"
              className="btn-primary mt-4 text-sm inline-flex" style={{background:'#16a34a'}}>
