  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-0.5">산안법 제29조 | 매 반기 1회 이상 | 8시간 이상/반기</p>
          </div>
        </div>
        <Link href="/documents/education/new?edu_type=supervisor-regular"
      ...
      <div className="card p-4 mb-4" style={{background:'#f5f3ff',borderColor:'#7c3aed20'}}>
        <p className="text-xs leading-relaxed" style={{color:'#7c3aed'}}>관리감독자(작업 직접 지휘·감독하는 자): 반기별 8시간 이상 | 교육내용: 산업안전 및 사고예방, 산업보건 및 직업병 예방 등</p>
      </div>
