...
export default function EduPage() {
  ...
  useEffect(() => {
    fetch('/api/documents/education?edu_type=special-employment&worker_type=atypical')
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-0.5">산안법 제77조 | 최초 노무제공 시 | 2시간 이상</p>
          </div>
        </div>
        <Link href="/documents/education/new?edu_type=special-employment"
          className="btn-primary text-sm gap-1.5" style={{background:'#6366f1'}}>
          <Plus className="w-4 h-4" /> 교육일지 작성
        </Link>
      </div>

      <div className="card p-4 mb-4" style={{background:'#eef2ff',borderColor:'#6366f120'}}>
        <p className="text-xs leading-relaxed" style={{color:'#6366f1'}}>특수형태근로종사자: 보험설계사, 택배기사, 퀵서비스, 대출모집인, 골프장 캐디 등 | 최초 노무제공 전 2시간 이상</p>
      </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="py-14 text-center text-sm text-gray-400">
            ...
            <p>아직 교육일지가 없습니다.</p>
            <Link href="/documents/education/new?edu_type=special-employment"
              className="btn-primary mt-4 text-sm inline-flex" style={{background:'#6366f1'}}>
