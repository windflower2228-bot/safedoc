...
export default function EduPage() {
  ...
  useEffect(() => {
    fetch('/api/documents/education?edu_type=supervisor-special&worker_type=supervisor')
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-0.5">산안법 제29조 | 유해·위험 작업 시 | 16시간 이상</p>
          </div>
        </div>
        <Link href="/documents/education/new?edu_type=supervisor-special"
          className="btn-primary text-sm gap-1.5" style={{background:'#b45309'}}>
          <Plus className="w-4 h-4" /> 교육일지 작성
        </Link>
      </div>

      <div className="card p-4 mb-4" style={{background:'#fffbeb',borderColor:'#b4530920'}}>
        <p className="text-xs leading-relaxed" style={{color:'#b45309'}}>유해·위험 작업을 지휘·관리하는 관리감독자 대상 | 해당 작업 수행 전 교육 필수</p>
      </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="py-14 text-center text-sm text-gray-400">
            ...
            <p>아직 교육일지가 없습니다.</p>
            <Link href="/documents/education/new?edu_type=supervisor-special"
              className="btn-primary mt-4 text-sm inline-flex" style={{background:'#b45309'}}>
